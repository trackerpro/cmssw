...
process.db_client.PedestalsParameters.fecMaskVector = cms.vuint32(3,4,11,13,14,14,16)
process.db_client.PedestalsParameters.ringVector = cms.vuint32(7,7,6,5,1,6,7)
process.db_client.PedestalsParameters.ccuVector = cms.vuint32(63,95,95,111,123,111,95)
process.db_client.PedestalsParameters.i2cChanVector = cms.vuint32(18,18,27,25,21,30,30)
process.db_client.PedestalsParameters.lldChanVector = cms.vuint32(1,2,3,3,3,3,3)
